...
def download_upload_data_dag(url_template, local_csv_path_template, gcs_path_template):
...
with DAG(
    ...
    for season in seasons:
        with TaskGroup(group_id=f'group{season}') as tg1:
        ...
        #             op_kwargs={
        #                 "bucket": BUCKET,
        #                 "object_name": EPL_GCS_PATH_TEMPLATE,
        #                 "local_file": EPL_CSV_FILE_TEMPLATE,
        #             },
        #         )
        #     rm_task = BashOperator(
        #     task_id="rm_task",
        #     bash_command=f"rm {EPL_CSV_FILE_TEMPLATE}"
        # )
